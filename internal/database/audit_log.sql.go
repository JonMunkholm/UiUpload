...
type CountAuditLogAllParams struct {
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
}

func (q *Queries) CountAuditLogAll(ctx context.Context, arg CountAuditLogAllParams) (int64, error) {
	row := q.db.QueryRow(ctx, countAuditLogAll, arg.CreatedAt, arg.CreatedAt_2)
	var count int64
	err := row.Scan(&count)
	return count, err
}

const countAuditLogArchiveAll = `-- name: CountAuditLogArchiveAll :one
SELECT COUNT(*) FROM audit_log_archive
WHERE created_at >= $1
  AND created_at <= $2
`

type CountAuditLogArchiveAllParams struct {
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
}

func (q *Queries) CountAuditLogArchiveAll(ctx context.Context, arg CountAuditLogArchiveAllParams) (int64, error) {
	row := q.db.QueryRow(ctx, countAuditLogArchiveAll, arg.CreatedAt, arg.CreatedAt_2)
	var count int64
	err := row.Scan(&count)
	return count, err
}

const countAuditLogArchiveByTable = `-- name: CountAuditLogArchiveByTable :one
SELECT COUNT(*) FROM audit_log_archive
WHERE table_key = $1
  AND created_at >= $2
  AND created_at <= $3
...
type CountAuditLogArchiveByTableParams struct {
	TableKey    string             `json:"table_key"`
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
}

func (q *Queries) CountAuditLogArchiveByTable(ctx context.Context, arg CountAuditLogArchiveByTableParams) (int64, error) {
	row := q.db.QueryRow(ctx, countAuditLogArchiveByTable, arg.TableKey, arg.CreatedAt, arg.CreatedAt_2)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
type CountAuditLogByTableParams struct {
	TableKey    string             `json:"table_key"`
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
}
...
const getAuditLogAll = `-- name: GetAuditLogAll :many
...
type GetAuditLogAllParams struct {
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
...
func (q *Queries) GetAuditLogAll(ctx context.Context, arg GetAuditLogAllParams) ([]AuditLog, error) {
	rows, err := q.db.Query(ctx, getAuditLogAll,
		arg.CreatedAt,
		arg.CreatedAt_2,
		arg.Limit,
		arg.Offset,
...
const getAuditLogByAction = `-- name: GetAuditLogByAction :many
SELECT id, action, severity, table_key, user_id, user_email, user_name, ip_address, user_agent, row_key, column_name, old_value, new_value, row_data, rows_affected, upload_id, batch_id, related_audit_id, reason, created_at FROM audit_log
WHERE action = $1
  AND created_at >= $2
  AND created_at <= $3
...
type GetAuditLogByActionParams struct {
	Action      string             `json:"action"`
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
	Limit       int32              `json:"limit"`
...
type GetAuditLogByTableParams struct {
	TableKey    string             `json:"table_key"`
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
	Limit       int32              `json:"limit"`
